...
////    }
//
//    public UIElementOld(Vector4DRect bounds, Color color, float radius) {
//        super(color, bounds, radius);
//    }
//
...
//    }
//
//    public void addChild(UIElementOld child) {
//        children.add(child);
//    }
//    public void removeChild(UIElementOld child) {
//        children.remove(child);
//    }
//
//    public void setHidden(boolean hidden) {
//        isHidden = hidden;
//        for (UIElementOld child : children) {
...
//        boolean isHovered = rectBounds.contains(position);
//        boolean isNearCorner = isNearBottomRightCorner(position);
//        boolean isGrabButtonPressed = pressedButtons.contains(1);
//
