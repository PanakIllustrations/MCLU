...
public class CombatRulesMixin {
    ...
    public static float getDamageAfterAbsorb(float baseDamage, float armor, float toughness) {
        ...
        double currentArmorValue = player.getAttribute(CustomAttributes.CURRENT_ARMOR.get()).getValue();
        ...
        if (currentArmorValue > 0) {
            ...
            player.getAttribute(CustomAttributes.CURRENT_ARMOR.get()).setBaseValue(newArmorValue);
